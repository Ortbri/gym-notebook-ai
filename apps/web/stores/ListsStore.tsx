...
export const useValuesCopy = (id: string): [string, (valuesCopy: string) => void] => [
...
export default function ShoppingListsStore() {
  ...
  return Object.entries(useTable('lists', storeId)).map(([listId]) => (
    <ShoppingListStore listId={listId} key={listId} useValuesCopy={useValuesCopy} />
  ));
}
