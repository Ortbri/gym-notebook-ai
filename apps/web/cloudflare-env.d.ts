// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 2fae7e55819afd2376eacae10b4c9abb)
// Runtime types generated with workerd@1.20250409.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		gymNotebookKV: KVNamespace;
		NEXTJS_ENV: string;
		DB: string;
		...
		gymNotebookR2: R2Bucket;
		gymNotebookDO: Fetcher;
