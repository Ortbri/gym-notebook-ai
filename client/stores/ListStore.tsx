...
export const useDelShoppingListProductCallback = (listId: string, productId: string) =>
...
export const useShoppingListProductIds = (
  ...
  offset?: number,
  limit?: number
) => useSortedRowIds('products', cellId, descending, offset, limit, useStoreId(listId));
...
export const useShoppingListProductCell = <CellId extends ShoppingListProductCellId>(
  listId: string,
  productId: string,
  cellId: CellId
): [Cell<Schemas[0], 'products', CellId>, (cell: Cell<Schemas[0], 'products', CellId>) => void] => [
...
export const useShoppingListProductCreatedByNickname = (listId: string, productId: string) => {
  const userId = useRemoteRowId('createdByNickname', productId, useStoreId(listId));
