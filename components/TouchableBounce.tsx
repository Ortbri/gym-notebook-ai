...
import { TouchableOpacityProps as RNTouchableOpacityProps, View } from 'react-native';
// @ts-expect-error: untyped helper
import RNTouchableBounce from 'react-native/Libraries/Components/Touchable/TouchableBounce';

export type TouchableScaleProps = Omit<RNTouchableOpacityProps, 'activeOpacity'> & {
