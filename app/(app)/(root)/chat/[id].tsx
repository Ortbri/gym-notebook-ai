...
export default function MusicScreen() {
  ...
  // const numericId =
  //   typeof id === 'string' ? parseInt(id, 10) : Array.isArray(id) ? parseInt(id[0], 10) : 0;
    ...
    return (
      <Animated.ScrollView
        ...
        <View style={{ flex: 1, alignItems: 'center', padding: 20, paddingTop: 30 }}>
          <Text style={{ color: 'white' }}>HELLO WORLD FROM CHAT ID: {id}</Text>
        </View>
      </Animated.ScrollView>
    );
  }, [id]);
    ...
    <View style={styles.container}>
      <GestureDetector gesture={composedGestures}>
        <Animated.View style={[styles.modalContent, animatedStyle]}>
          <ExpandedView scrollComponent={ScrollComponent} />
        </Animated.View>
      </GestureDetector>
    </View>
  );
